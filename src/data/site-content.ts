...
export const seoKeywords = {
  primary: ["self loading concrete mixer", "self loading concrete mixer truck", "self loading mixer manufacturer", "self loading concrete mixer for sale", "China concrete mixer manufacturer"],
  models: ["0.8m3 self loading concrete mixer", "1.5m3 self loading concrete mixer", "2m3 self loading concrete mixer", "2.6m3 self loading concrete mixer", "3.5m3 self loading concrete mixer", "4m3 self loading concrete mixer", "5m3 self loading concrete mixer"],
  commercial: ["self loading concrete mixer price", "self loading concrete mixer factory", "self loading mixer supplier China", "OEM self loading concrete mixer", "self loading concrete mixer distributor"],
  features: ["4x4 self loading concrete mixer", "mobile concrete batching mixer", "automatic loading concrete mixer", "concrete mixer with weighing system", "off road concrete mixer truck"],
  applications: ["concrete mixer for road construction", "concrete mixer for mining project", "concrete mixer for water conservancy", "concrete mixer for remote construction", "concrete mixer for municipal engineering"],
};
